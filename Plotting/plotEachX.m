...
plot3(ax3,plotValues(:,1),plotValues(:,2),plotValues(:,6),plotValues2(:,1),plotValues2(:,2),plotValues2(:,6),'r')

% title(ax3,[ num2str(percentComplete) ' Percent Complete, CH3 (red) CH4 (blue)'])
title(ax3,[ '[' demoText '] (' num2str(percentComplete) '%) XY CH3 Voltage Measured , Z Min (red) Z Max(blue)'])
